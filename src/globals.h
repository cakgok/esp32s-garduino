...
namespace ConfigConstants {
    ...
    constexpr uint32_t MAX_TELEMETRY_INTERVAL = 3600000; // 60 minutes
    constexpr uint32_t MIN_SENSORUPDATE_INTERVAL = 10000;  // 10 seconds
    constexpr uint32_t MAX_SENSORUPDATE_INTERVAL = 3600000; // 10 minutes
    constexpr uint32_t MIN_LCD_INTERVAL = 1000;  // 1 seconds
    ...
    constexpr uint32_t MAX_SENSOR_PUBLISH_INTERVAL = 3600000;
    ...
    constexpr uint32_t DEFAULT_SENSOR_UPDATE_INTERVAL = 60000; // 10 seconds
